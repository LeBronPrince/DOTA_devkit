...
category_set = ['baseball-diamond', 'basketball-court', 'bridge',
    'ground-track-field', 'harbor', 'helicopter', 'large-vehicle', 'plane',
    'roundabout','ship','small-vehicle','soccer-ball-field','storage-tank','swimming-pool','tennis-court']
...
if __name__ == '__main__':
    images_path = '/home/f523/guazai/sda/wangyang/detection/Datatemp/VOC2007/JPEGImages' # 样本图片路径
    labeltxt_path = '/home/f523/guazai/sda/wangyang/detection/Datatemp/VOC2007/labelTxt' # DOTA标签的所在路径
    ...
    for filename in filenames:
        filepath = os.path.join(labeltxt_path,filename)    #每一个DOTA标签的具体路径
